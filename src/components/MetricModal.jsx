...
const MetricModal = ({ isOpen, onClose, metricType, currentValue, isDarkMode, shareToSocial }) => {
  ...
  const getMetricData = (type) => {
    const metrics = {
      co2: {
        ...
        statusColor: 'red',
        explanation:
          "Carbon dioxide concentration in Earth's atmosphere, measured in parts per million (ppm). This is the primary driver of human-caused climate change.",
        historicalContext: {
      ...
      temp: {
        ...
        statusColor: 'red',
        explanation:
          'How much warmer Earth is compared to pre-industrial average (1850-1900). Each degree of warming has massive global impacts.',
        historicalContext: {
      ...
      deforestation: {
        ...
        statusColor: 'red',
        explanation:
          'Hectares of forest lost daily worldwide. Forests are crucial for carbon storage, biodiversity, and climate regulation.',
        historicalContext: {
      ...
      oceanPlastic: {
        ...
        statusColor: 'red',
        explanation:
          'Annual plastic waste entering oceans. Creates massive garbage patches and harms marine life through ingestion and entanglement.',
        historicalContext: {
      ...
      seaLevel: {
        ...
        statusColor: 'red',
        explanation:
          'Annual rate of global mean sea level rise measured by satellite altimetry. Threatens coastal communities worldwide.',
        historicalContext: {
      ...
      biodiversity: {
        ...
        statusColor: 'red',
        explanation:
          'Percentage of wildlife populations remaining since 1970. Represents average change across 34,000+ monitored vertebrate populations.',
        historicalContext: {
          baseline: '100% (1970)',
  ...
  const MiniChart = ({ data, labels, type = 'line' }) => {
    ...
    return (
      <div
        className={`w-full h-24 relative rounded-lg p-2 overflow-hidden ${
          isDarkMode
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div
        className={`max-w-4xl w-full max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl border ${
          isDarkMode
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <MiniChart data={metric.chart.historical} labels={metric.chart.years} type="line" />
            </div>
          </div>

...
const CarbonCountdown = ({ isDarkMode }) => {
  ...
  return (
    <div
      className={`p-3 rounded-xl backdrop-blur-xl shadow-xl border transition-all duration-300 hover:scale-105 ${
        isDarkMode
    ...
    >
      ...
      <div className="mb-2">
        <div className="flex items-center justify-center space-x-2 text-center">
          <div>
            <div
              className={`text-lg font-bold font-mono ${isDarkMode ? 'text-orange-200' : 'text-orange-800'}`}
          ...
          <div>
            <div
              className={`text-sm font-bold font-mono ${isDarkMode ? 'text-orange-200' : 'text-orange-800'}`}
              style={{
                animation: timeRemaining.seconds % 2 === 0 ? 'pulse 1s ease-in-out' : 'none',
              }}
            >
              {formatTimeUnit(timeRemaining.hours)}:{formatTimeUnit(timeRemaining.minutes)}:

...
const ClimateUrgencyMeter = ({ isDarkMode }) => (
  <div
    className={`p-4 rounded-2xl backdrop-blur-xl shadow-xl border transition-all duration-300 hover:scale-105 ${
  ...
  >
    ...
    <div className={`text-xs mb-2 ${isDarkMode ? 'text-red-200' : 'text-red-800'}`}>
      ~6 years to limit warming to 1.5°C
    </div>
    <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
      <div
        className="bg-gradient-to-r from-red-500 to-red-600 h-2 rounded-full animate-pulse relative"
    ...
    <div className={`text-xs mt-1 ${isDarkMode ? 'text-red-200' : 'text-red-700'}`}>

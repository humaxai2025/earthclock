...
const ClimateUrgencyMeter = ({ isDarkMode }) => (
  <div className={`p-4 rounded-2xl backdrop-blur-xl shadow-xl border transition-all duration-300 hover:scale-105 ${
    ...
    <div className="text-xs opacity-80 mb-2">~6 years to limit warming to 1.5°C</div>
    ...
    <div className="text-xs text-red-400 mt-1 opacity-80">Immediate action required</div>
  </div>
);

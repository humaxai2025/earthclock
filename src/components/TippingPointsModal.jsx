...
const TippingPointsModal = ({ isOpen, onClose, isDarkMode }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div
        className={`max-w-7xl w-full max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl border ${
          isDarkMode
      ...
      >
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className="text-sm opacity-70">
                  • {tippingPointsData.currentWarming} current warming
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed">
                  Climate tipping points are critical thresholds where small changes in global
                  temperature can push Earth's climate system into irreversible changes. Once
                  crossed, these systems can't return to their previous state for decades,
                  centuries, or even millennia. Currently, {tippingPointsData.triggered} out of{' '}
                  {tippingPointsData.total} major tipping points have been triggered.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-sm leading-relaxed">
              With {tippingPointsData.triggered} tipping points already triggered and{' '}
              {tippingPointsData.atRisk} more at high risk, we're in a race against time. Every
              fraction of a degree matters. Staying below 1.5°C warming could prevent triggering
              additional cascading tipping points that would make climate chaos unstoppable.
            </p>
          </div>

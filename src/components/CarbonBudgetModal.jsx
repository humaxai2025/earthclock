...
const CarbonBudgetModal = ({ isOpen, onClose, isDarkMode }) => {
  ...
  const ScenarioCard = ({ scenario }) => (
    ...
    >
      <h4 className={`font-semibold text-${scenario.color}-400 mb-2`}>{scenario.name}</h4>
      ...
      <div className="text-xs">
        ...
        <div className={`text-${scenario.color}-400 font-medium mt-1`}>{scenario.likelihood}</div>
      </div>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div
        className={`max-w-5xl w-full max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl border ${
          isDarkMode
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className="text-sm opacity-70">
                  • {carbonBudgetData.timeLeft} at current rate
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed">
                  The global carbon budget represents the total amount of CO₂ that can be emitted
                  while limiting global warming to 1.5°C above pre-industrial levels. At current
                  emission rates of {carbonBudgetData.currentEmissions}, we have approximately{' '}
                  {carbonBudgetData.timeLeft} before this budget is exhausted.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              <div className="text-2xl font-bold text-orange-400">
                {carbonBudgetData.currentEmissions}
              </div>
            ...
            >
              <div className="text-2xl font-bold text-purple-400">
                {carbonBudgetData.reductionNeeded}
              </div>

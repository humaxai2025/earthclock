...
const TimeDisplay = ({ currentTime, pulseAnimation, isDarkMode }) => {
  ...
  return (
    <div
      className={`p-6 rounded-3xl backdrop-blur-xl shadow-2xl border transition-all duration-700 hover:scale-[1.02] group ${
        isDarkMode
    ...
    >
      <div className="text-center">
        <div
          className={`text-4xl lg:text-5xl font-mono font-bold mb-3 tracking-wider transition-all duration-1000 ${
